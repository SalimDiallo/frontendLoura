...
export const LEGACY_PERMISSION_MAPPING: Record<string, string> = {
  ...
  'can_view_position': HR_PERMISSIONS.VIEW_POSITIONS,
  'can_create_position': HR_PERMISSIONS.CREATE_POSITIONS,
  'can_update_position': HR_PERMISSIONS.UPDATE_POSITIONS,
  'can_delete_position': HR_PERMISSIONS.DELETE_POSITIONS,
  ...
  'can_delete_role': HR_PERMISSIONS.DELETE_ROLES,
  'can_view_contract': HR_PERMISSIONS.VIEW_CONTRACTS,
  'can_create_contract': HR_PERMISSIONS.CREATE_CONTRACTS,
  'can_update_contract': HR_PERMISSIONS.UPDATE_CONTRACTS,
  'can_delete_contract': HR_PERMISSIONS.DELETE_CONTRACTS,
  ...
  'can_update_payroll': HR_PERMISSIONS.UPDATE_PAYROLL,
  'can_export_payroll': HR_PERMISSIONS.EXPORT_PAYROLL,
  'can_view_attendance': HR_PERMISSIONS.VIEW_ATTENDANCE,
  'can_view_all_attendance': HR_PERMISSIONS.VIEW_ALL_ATTENDANCE,
  'can_create_attendance': HR_PERMISSIONS.CREATE_ATTENDANCE,
  'can_update_attendance': HR_PERMISSIONS.UPDATE_ATTENDANCE,
  'can_delete_attendance': HR_PERMISSIONS.DELETE_ATTENDANCE,
  'can_approve_attendance': HR_PERMISSIONS.APPROVE_ATTENDANCE,
  'can_manual_checkin': HR_PERMISSIONS.MANUAL_CHECKIN,
  'can_create_qr_session': HR_PERMISSIONS.CREATE_QR_SESSION,
  ...
  'employee.manage': HR_PERMISSIONS.UPDATE_EMPLOYEES,
  'employee.manage_permissions': HR_PERMISSIONS.MANAGE_EMPLOYEE_PERMISSIONS,
  ...
  'position.view': HR_PERMISSIONS.VIEW_POSITIONS,
  'position.create': HR_PERMISSIONS.CREATE_POSITIONS,
  'position.update': HR_PERMISSIONS.UPDATE_POSITIONS,
  'position.delete': HR_PERMISSIONS.DELETE_POSITIONS,
  ...
  'role.assign': HR_PERMISSIONS.UPDATE_ROLES,
  'contract.view': HR_PERMISSIONS.VIEW_CONTRACTS,
  'contract.create': HR_PERMISSIONS.CREATE_CONTRACTS,
  'contract.update': HR_PERMISSIONS.UPDATE_CONTRACTS,
  'contract.delete': HR_PERMISSIONS.DELETE_CONTRACTS,
  'leave_request.view': HR_PERMISSIONS.VIEW_LEAVE_REQUESTS,
  'leave_request.create': HR_PERMISSIONS.CREATE_LEAVE_REQUESTS,
  'leave_request.update': HR_PERMISSIONS.CREATE_LEAVE_REQUESTS,
  'leave_request.delete': HR_PERMISSIONS.CREATE_LEAVE_REQUESTS,
  ...
  'payroll.update': HR_PERMISSIONS.UPDATE_PAYROLL,
  'payroll.delete': HR_PERMISSIONS.UPDATE_PAYROLL,
  'payroll.process': HR_PERMISSIONS.UPDATE_PAYROLL,
  'payroll.export': HR_PERMISSIONS.EXPORT_PAYROLL,
  ...
  'attendance.update': HR_PERMISSIONS.UPDATE_ATTENDANCE,
  'attendance.delete': HR_PERMISSIONS.DELETE_ATTENDANCE,
  ...
  'category.create': INVENTORY_PERMISSIONS.CREATE_CATEGORIES,
  'category.update': INVENTORY_PERMISSIONS.UPDATE_CATEGORIES,
  'category.delete': INVENTORY_PERMISSIONS.DELETE_CATEGORIES,
  'warehouse.view': INVENTORY_PERMISSIONS.VIEW_WAREHOUSES,
  'warehouse.create': INVENTORY_PERMISSIONS.CREATE_WAREHOUSES,
  'warehouse.update': INVENTORY_PERMISSIONS.UPDATE_WAREHOUSES,
  'warehouse.delete': INVENTORY_PERMISSIONS.DELETE_WAREHOUSES,
  'supplier.view': INVENTORY_PERMISSIONS.VIEW_SUPPLIERS,
  'supplier.create': INVENTORY_PERMISSIONS.CREATE_SUPPLIERS,
  'supplier.update': INVENTORY_PERMISSIONS.UPDATE_SUPPLIERS,
  'supplier.delete': INVENTORY_PERMISSIONS.DELETE_SUPPLIERS,
  'stock.view': INVENTORY_PERMISSIONS.VIEW_STOCK,
  'stock.manage': INVENTORY_PERMISSIONS.MANAGE_STOCK,
  'stock.adjust': INVENTORY_PERMISSIONS.ADJUST_STOCK,
  'order.view': INVENTORY_PERMISSIONS.VIEW_ORDERS,
  'order.create': INVENTORY_PERMISSIONS.CREATE_ORDERS,
  'order.update': INVENTORY_PERMISSIONS.UPDATE_ORDERS,
  'order.delete': INVENTORY_PERMISSIONS.DELETE_ORDERS,
  'sale.view': INVENTORY_PERMISSIONS.VIEW_SALES,
  'sale.create': INVENTORY_PERMISSIONS.CREATE_SALES,
  'sale.update': INVENTORY_PERMISSIONS.UPDATE_SALES,
  'sale.delete': INVENTORY_PERMISSIONS.DELETE_SALES,
};
