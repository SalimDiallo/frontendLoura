...
import { COMMON_PERMISSIONS } from "../types/permissions";
...
export const HR_ROUTE_PERMISSIONS: Record<string, RouteProtectionConfig> = {
  ...
  // Employees
  '/hr/employees': {
    requiredPermissions: [COMMON_PERMISSIONS.HR.VIEW_EMPLOYEES],
    deniedMessage: "Vous n'avez pas la permission de consulter la liste des employés.",
  },

  '/hr/employees/create': {
    requiredPermissions: [COMMON_PERMISSIONS.HR.CREATE_EMPLOYEES],
  ...
  '/hr/employees/[id]/edit': {
    requiredPermissions: [COMMON_PERMISSIONS.HR.UPDATE_EMPLOYEES],
  ...
  // Roles
  '/hr/roles': {
    requiredPermissions: [COMMON_PERMISSIONS.HR.VIEW_ROLES],
    deniedMessage: "Vous n'avez pas la permission de consulter les rôles.",
  },

  '/hr/roles/create': {
    requiredPermissions: [COMMON_PERMISSIONS.HR.CREATE_ROLES],
    deniedMessage: "Vous n'avez pas la permission de créer des rôles.",
    redirectTo: '../',
  },

  '/hr/roles/[id]/edit': {
    requiredPermissions: [COMMON_PERMISSIONS.HR.UPDATE_ROLES],
  ...
  // Leave Requests
  '/hr/leaves': {
    requiredPermissions: [COMMON_PERMISSIONS.HR.VIEW_LEAVE_REQUESTS],
    deniedMessage: "Vous n'avez pas la permission de consulter les demandes de congés.",
  },

  '/hr/leaves/create': {
    requiredPermissions: [COMMON_PERMISSIONS.HR.CREATE_LEAVE_REQUESTS],
  ...
  '/hr/contracts/:id/edit': {
    requiredPermissions: [COMMON_PERMISSIONS.HR.UPDATE_CONTRACTS],
...
export const INVENTORY_ROUTE_PERMISSIONS: Record<string, RouteProtectionConfig> = {
  // Products
  '/inventory/products': {
    requiredPermissions: [COMMON_PERMISSIONS.INVENTORY.VIEW_PRODUCTS],
    deniedMessage: "Vous n'avez pas la permission de consulter les produits.",
  },

  '/inventory/products/create': {
    requiredPermissions: [COMMON_PERMISSIONS.INVENTORY.CREATE_PRODUCTS],
